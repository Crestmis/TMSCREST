...
function setupSheets(){
  ...
  var TASK_HEADERS=['Task ID','Plan ID','Task Description','Department','Given By','Name','Task Start Date','Task Start Time','Freq','Status','Require Attachment','Enable Reminders','Remarks','Actual Date','Actual Time','Completion Type','Responsibility Confirmed','Confirmed At'];
  var defs={
    ...
    'UNIQUE':['Value'],
    'TASK HISTORY':['Task ID','Plan ID','Task Description','Task Type','Doer','Given By','Department','Planned Date','Planned Time','Actual Date','Actual Time','Status','Completion Type','Remarks','Submitted Date'],
    'DELEGATION DONE':['Timestamp','Task ID','Plan ID','Planned Date','Status','Completion Type','Next Target Date','Remarks','Attachment','Submitted Date','Actual Date','Actual Time','Responsibility Confirmed','Doer','Task','Given By','Department'],

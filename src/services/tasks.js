...
import {readRows,normalize,displayDate,isoDate,parseDate,postAppsScript} from './sheets'
...
export async function completeTask(task,{status='Done',remarks='',nextTargetDate='',attachmentUrl='',actualDate='',completionType='',responsibilityConfirmed=false}={}){
  return postAppsScript({action:'complete',task,status,remarks,nextTargetDate,attachmentUrl,actualDate,completionType,responsibilityConfirmed,sheetName:task.type==='checklist'?CONFIG.SHEETS.CHECKLIST:CONFIG.SHEETS.DELEGATION})
}

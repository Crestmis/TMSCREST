...
import { getDemoSheet, insertDemoTask, completeDemoTask, demoAccessRows, saveDemoAccess, submitDemoSupport, createDemoUser } from '../data/demoStore'
...
export async function postAppsScript(fields){
 if(CONFIG.DEMO_MODE){
   ...
   if(fields.action==='complete'){return completeDemoTask(fields.task,{status:fields.status,remarks:fields.remarks,nextTargetDate:fields.nextTargetDate,attachmentUrl:fields.attachmentUrl,actualDate:fields.actualDate,completionType:fields.completionType,responsibilityConfirmed:fields.responsibilityConfirmed})}
